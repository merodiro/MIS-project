<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show4.aspx.cs" Inherits="MIS_project.show4" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ASUS X540SA</title>
    ...
    <div class="product">
        <div class="container">
            <div class="image fl-left">
                <img src="images/products/asus_02.jpg" alt="ASUS X540SA">
            </div>
            <div class="info fl-left">
                <h2>ASUS X540SA</h2>
                <p>Top product by Asus, a new cutting edge technology</p>
                <div class="specs">
